...
func Test_service_SendImage(t *testing.T) {
	...
	t.Log(service.SendImage(token,
		"wangmingfeng", "", "", "3vHXD0a1oJCR9vlL5Ah07h6PMw-70GIapdEKrQrtrI-rpB929jbp7UekQAN1heDV-", WithOptionSafe(1)))
}
...
func Test_service_SendVideo(t *testing.T) {
	...
	t.Log(service.SendVideo(token,
		"wangmingfeng", "", "", "3brePNyB5mHgrlVdVOs_s6oMIPSxYG18moBPxAdCK_K7yyWxCF3-wJi5LSrGseTGH", "3d2", "测试视频", WithOptionSafe(1)))
}
...
func Test_service_SendVoice(t *testing.T) {
	...
	t.Log(service.SendVoice(token,
		"wangmingfeng", "", "", "3fP2dp0GlgIpx1Zeo7Q-JbqGU8m3j3qqho9x3pVLSAqAXC_0Y5FROeGYgSOjSQ8C3", WithOptionEnableIdTrans(1)))
}
